...
$css = Get-Content -LiteralPath (Join-Path $root 'css/sop-dashboard.css') -Raw -Encoding utf8
$chartJs = Get-Content -LiteralPath (Join-Path $root 'js/chart.min.js') -Raw -Encoding utf8
$dataJs = Get-Content -LiteralPath (Join-Path $root 'js/fpt-data.js') -Raw -Encoding utf8
$appJs = Get-Content -LiteralPath (Join-Path $root 'js/sop-app.js') -Raw -Encoding utf8
